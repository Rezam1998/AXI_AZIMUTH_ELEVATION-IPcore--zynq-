...
HD_PWD='D:/Projects/probation training/linux laptop ip_repo/ip_repo/edit_Azimuth_test_axi_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Azimuth_test_axi_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Azimuth_test_axi_v1_0.tcl
